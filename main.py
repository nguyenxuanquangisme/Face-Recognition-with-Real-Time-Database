...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "face-recognition-real-ti-30341.appspot.com"
...
# Sort the modePathList
sortedModePathList = sorted(modePathList, key=lambda x: int(x.split('.')[0]))

imgModeList = []
for path in sortedModePathList:
    print(path)
